...
export const trackingUpdateSchema = z
  .object({
    busId: z
      ...
      .min(1)
      .max(30)
      .describe('Bus to update tracking for'),
    lat: z
      .number()
      .min(-90)
      .max(90)
      .describe('Current latitude coordinate'),
    lng: z
      .number()
      .min(-180)
      .max(180)
      .describe('Current longitude coordinate'),
    speed: z
      .number()
      .min(0)
      .max(300)
      .describe('Current speed in km/h'),
    heading: z
      .number()
      .min(0)
      .max(360)
    ...
    tripDate: z
      ...
      .date()
      .max(10)
      .describe('Date of the current trip')
      .optional(),
  })
  .strict();
...
export const busTrackingSchema = z.object({
  ...
  scheduleId: z
    ...
    .max(30)
    .nullable()
    .describe('Active schedule this bus is running'),
  currentStopIndex: z
    .number()
    .int()
    .min(0)
  ...
  isActive: z
    .boolean()
    .describe('Whether the bus is actively transmitting position'),
  tripDate: z
    .string()
    .datetime()
    .max(30)
  ...
  updatedAt: z
    ...
    .datetime()
    .max(30)
    .describe('Last position update timestamp'),
});
