...
const QUICK_ACTIONS = [
  ...
  { href: '/admin/fleet', label: 'Manage Fleet', icon: Bus },
  ...
  return (
    <li className="flex items-center gap-4 rounded-lg border border-border/50 p-4">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="text-sm text-muted-foreground">{userEmail ?? 'Unknown user'}</p>
      </div>
...
export default function AdminDashboardPage() {
  ...
  const heading = user?.name ? `Welcome, ${user.name}` : 'Admin Dashboard';
