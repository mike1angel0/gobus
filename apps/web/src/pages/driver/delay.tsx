...
/** Human-readable labels for each delay reason. */
const REASON_LABELS: Record<(typeof DELAY_REASONS)[number], string> = {
  TRAFFIC: 'Traffic',
...
function PresetButtons({ selected, onSelect }: PresetButtonsProps) {
  return (
    <div className="grid grid-cols-4 gap-2" role="group" aria-label="Preset delay options">
  ...
  if (!scheduleId || !tripDate) {
    return (
      <div className="mx-auto w-full max-w-lg px-4 py-6">
        <p className="text-muted-foreground">Missing schedule or date information.</p>
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} noValidate className="space-y-6">
            ...
            {/* Notes */}
            <div>
              <Label htmlFor="delay-note">Notes (optional)</Label>
              <textarea
                id="delay-note"
